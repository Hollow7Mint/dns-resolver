"""Dns Resolver — parser for zone payloads."""
...
def parse_zones(payload: str) -> List[Dict[str, Any]]:
    """Parse a JSON array of Zone payloads."""
...
def validate_zone_to_str(
    record: Dict[str, Any], indent: Optional[int] = None
) -> str:
    """Convenience wrapper — serialise a Zone to a JSON string."""
    if indent is None:
